...
class Topup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('agent_id, bank_id, account_id, status_id, created_by, updated_by', 'numerical', 'integerOnly'=>true),
			array('amount', 'numerical'),
			array('code, reference_number, location, disable', 'length', 'max'=>255),
			array('topup_date, remark, created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, code, agent_id, bank_id, location, account_id, topup_date, reference_number, amount, status_id, remark, created_at, created_by, updated_at, updated_by, disable', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('location',$this->location_id);
