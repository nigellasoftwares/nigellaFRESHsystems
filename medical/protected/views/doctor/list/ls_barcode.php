            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form-barcode-search">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span class="label label-primary2">Worker Profile</span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
									...
									<!--
                                    <input type="text" name="workername" class="form-control" placeholder="Worker Name" value="MATT DOUGLAS DAMON" />
									<input type="hidden" name="barcode" class="form-control" placeholder="Barcode" required="true" value="26D8714D-3186-5F4C-18BA-7896C14EC8EA" />
									-->
                                </div>
                            </div>
                        </div>
