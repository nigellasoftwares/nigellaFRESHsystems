                    ...
                    <div class="col-12">
                        <div class="social-widget">
                            ...
                            <div class="soc-content">
                                <div class="col-3 edge-bottom">
                                    <i class="fa fa-check text-success"></i>
                                    <span class="label label-info">DEL</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['d']['osc']['in']); ?></h3>
                                </div>
                                <div class="col-3 edge-right edge-bottom">
                                    <i class="fa fa-check text-success"></i>
                                    <span class="label label-info">VER</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['d']['osc']['verify']); ?></h3>
                                </div>
                                <div class="col-3 edge-bottom">
                                    <i class="fa fa-check text-success"></i>
                                    <span class="label label-info">RET</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['r']['osc']['in']); ?></h3>
                                </div>
                                <div class="col-3 edge-bottom">
                                    <i class="fa fa-check text-success"></i>
                                    <span class="label label-info">VER</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['r']['osc']['verify']); ?></h3>
                                </div>
                            </div>
                            <div class="soc-content">
                                <div class="col-3">
                                    ...
                                    <span class="label label-info">RET</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['d']['osc']['not_in']); ?></h3>
                                </div>
                                <div class="col-3 edge-right">
                                    <i class="fa fa-times text-danger"></i>
                                    <span class="label label-info">VER</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['d']['osc']['not']); ?></h3>
                                </div>
                                <div class="col-3">
                                    <i class="fa fa-times text-danger"></i>
                                    <span class="label label-info">RET</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['r']['osc']['not_in']); ?></h3>
                                </div>
                                <div class="col-3">
                                    <i class="fa fa-times text-danger"></i>
                                    <span class="label label-info">VER</span>
                                    <h3 class="font-medium"><?php echo number_format($report['track']['r']['osc']['not']); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="align-self-center m-l-20">
                        <div class="row m-t-20">
                            <form id="form-report-visa" class="form-horizontal" action="index.php?r=Osc/Report" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-5">
                ...
                <table id="table-application-report" class="table table-bordered table-striped">
                    ...
                    <?php
                        if(count($report['batch']) > 0){
                            $i = 0;
                            foreach($report['admin'] as $k => $v){
                                $i++;
                                $admin = Admin::model()->findByPk($k);
                    ?>        
                        <tr>
                            <td class="bg-info text-white"><?php echo $i; ?></td>
                            <td colspan="12" class="bg-info text-white"><?php echo $admin->user->profile->company->name; ?></td>
                        </tr>
                    <?php
                                $j = 0;
                                foreach($v as $w){
                                    $j++;
                                    $branch = Branch::model()->findByPk($w);
                                    
                                    if($type == 'on'){
                                        $batch = Batch::model()->reportBatchByBranch($branch->id,$branch->admin_id,$report['startformatdate'],$report['endformatdate']);
                                    } else {
                                        $batch = Batch::model()->statBatchByBranch($branch->id,$branch->admin_id);
                                    }
                    ?>        
                        <tr>
                            <td class="bg-warning"><?php echo $j; ?></td>
                            <td colspan="12" class="bg-warning"><?php echo $branch->user->profile->company->name; ?></td>
                        </tr>
                    <?php       
                                    $m = 0;
                                    foreach($batch as $b){
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-right bg2-yellow"><?php echo number_format($total_vln); ?></td>
                            <td class="text-right bg2-yellow"><?php echo number_format($total_osc); ?></td>
                            <td class="text-right"><?php echo number_format($total_fee); ?></td>
                        </tr>
                    <?php                    
                                    }    
                                }
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/osc/report2.js", CClientScript::POS_END);