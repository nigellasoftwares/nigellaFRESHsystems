                        ...
                        <div class="social-widget">
                            ...
                            <div class="soc-content">
                                <div class="col-4 b-r edge-right <?php echo $labelstatus['d_brn_process']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>">
                                ...
                                <div class="col-4 edge-bottom <?php echo $labelstatus['r_brn_out']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=17">
                                ...
                                <div class="col-4 edge-bottom <?php echo $labelstatus['r_brn_verify']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=18">
                            ...
                            <div class="soc-content">
                                ...
                                <div class="col-4 <?php echo $labelstatus['r_brn_out_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=17&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_r_brn_out_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-4 <?php echo $labelstatus['r_brn_verify_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=18&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                        ...
                        <div class="social-widget">
                            ...
                            <div class="soc-content">
                                <div class="col-3 b-r edge-bottom <?php echo $labelstatus['d_adm_in']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=2">
                                ...
                                <div class="col-3 edge-right edge-bottom <?php echo $labelstatus['d_adm_verify']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=3">
                                        <h6 class="text-muted">Verify</h6>
                                        <i class="fa fa-check text-success"></i>
                                ...
                                <div class="col-3 edge-bottom <?php echo $labelstatus['r_adm_out']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=15">
                                        <h6 class="text-muted">Return</h6>
                                        <i class="fa fa-check text-success"></i>
                                ...
                                <div class="col-3 edge-bottom <?php echo $labelstatus['r_adm_verify']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=16">
                                        <h6 class="text-muted">Verify</h6>
                                        <i class="fa fa-check text-success"></i>
                            ...
                            <div class="soc-content">
                                <div class="col-3 b-r <?php echo $labelstatus['d_adm_in_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=2&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_d_adm_in_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 edge-right <?php echo $labelstatus['d_adm_verify_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=3&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_d_adm_verify_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 <?php echo $labelstatus['r_adm_out_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=15&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_r_adm_out_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 <?php echo $labelstatus['r_adm_verify_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=16&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                        ...
                        <div class="social-widget">
                            ...
                            <div class="soc-content">
                                <div class="col-3 b-r edge-bottom <?php echo $labelstatus['d_osc_in']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=5">
                                        <h6 class="text-muted">Deliver</h6>
                                        <i class="fa fa-check text-success"></i>
                                ...
                                <div class="col-3 edge-right edge-bottom <?php echo $labelstatus['d_osc_verify']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=6">
                                        <h6 class="text-muted">Verify</h6>
                                        <i class="fa fa-check text-success"></i>
                                ...
                                <div class="col-3 edge-bottom <?php echo $labelstatus['r_osc_out']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=13">
                                        <h6 class="text-muted">Return</h6>
                                        <i class="fa fa-check text-success"></i>
                                ...
                                <div class="col-3 edge-bottom <?php echo $labelstatus['r_osc_verify']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=14">
                                        <h6 class="text-muted">Verify</h6>
                                        <i class="fa fa-check text-success"></i>
                            ...
                            <div class="soc-content">
                                <div class="col-3 b-r <?php echo $labelstatus['d_osc_in_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=5&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_d_osc_in_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 edge-right <?php echo $labelstatus['d_osc_verify_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=6&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_d_osc_verify_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 <?php echo $labelstatus['r_osc_out_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=13&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                                        <h3 class="font-medium"><?php echo $dash_r_osc_out_not; ?></h3>
                                    </a>
                                </div>
                                <div class="col-3 <?php echo $labelstatus['r_osc_verify_not']; ?>">
                                    <a class="dashlink" href="index.php?r=Admin/ApplicationReport&id=<?php echo $batch->id; ?>&rid=14&tid=1">
                                        <i class="fa fa-times text-danger"></i>
                ...
                <table id="table-application-report" class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center <?php echo $bg_adm; ?>"><?php echo $statusscan['d_adm_in']; ?></td>
                            <td class="text-center <?php echo $bg_adm; ?>"><?php echo $statusscan['d_adm_verify']; ?></td>
                            ...
                            <td class="text-center <?php echo $bg_adm; ?>"><?php echo $statusscan['r_adm_out']; ?></td>
                            <td class="text-center <?php echo $bg_adm; ?>"><?php echo $statusscan['r_adm_verify']; ?></td>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/admin/applicationreport.js", CClientScript::POS_END);