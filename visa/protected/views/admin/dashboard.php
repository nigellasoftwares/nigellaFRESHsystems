                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger"><?php echo number_format($stat['today']['track']['d']['adm']['not']); ?></h3>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger"><?php echo number_format($stat['today']['track']['r']['adm']['not']); ?></h3>
                                <h5 class="text-muted m-b-0">Not Verified Today</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0">DL</h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo number_format($stat['today']['track']['d']['adm']['verify']); ?></h3>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0">RT</h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo number_format($stat['today']['track']['r']['adm']['verify']); ?></h3>
                                <h5 class="text-muted m-b-0">Verified Today</h5>
                            </div>
                        </div>
                    </div>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/admin/dashboard.js", CClientScript::POS_END);