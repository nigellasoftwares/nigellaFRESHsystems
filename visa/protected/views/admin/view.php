    ...
    <div class="card">
        <div class="card-body">
            <div class="pull-right">
                <a href="index.php?r=Admin/ApplicationBatch&id=<?php echo $applicant->batch_id; ?>" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/admin/applicationapplicantview.js", CClientScript::POS_END);