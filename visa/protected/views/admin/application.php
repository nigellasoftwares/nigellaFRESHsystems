                ...
                <table id="table-application-batch" class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?r=Admin/ApplicationBatch&id=<?php echo $b->id; ?>" class="btn btn-sm waves-effect waves-light btn-info text-white" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="fa fa-search"></i></a>
                                <a href="index.php?r=Admin/ApplicationReport&id=<?php echo $b->id; ?>" class="btn btn-sm waves-effect waves-light btn-warning text-dark" data-toggle="tooltip" data-placement="top" title="Report" data-original-title="Report"><i class="fa fa-files-o"></i></a>
                            </td>
                        </tr>
                    <?php
                        }
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/admin/application.js", CClientScript::POS_END);