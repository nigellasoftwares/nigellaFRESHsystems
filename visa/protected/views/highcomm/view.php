    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                        if($applicant->result_id == 9){
                            $result_disable = NULL;
                            $result_icon = 'fa fa-refresh fa-spin';
                        } else {
                            $result_disable = 'disabled';
                            $result_icon = 'fa fa-ban';
                        }
                    ?>
                    
                    <div class="pull-right">
                        <a data-id="<?php echo $applicant->id ?>" class="btn btn-sm waves-effect waves-light btn-info text-white visa-result <?php echo $result_disable; ?>" data-toggle="tooltip" data-placement="top" title="Result" data-original-title="Result">
                            <i class="<?php echo $result_icon; ?>"></i> Result
                        </a>
                    </div>
...
<div class="modal fade" id="modal-update-result">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-update-result">
                <input type="hidden" name="applicant_id" class="applicant-id">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label"><strong>Result</strong> <span class="text-danger">*</span></label>
                                <?php
                                    $result_list = CHtml::listData($result, 'id', 'stage');
                                    echo CHtml::dropDownList('result', null, $result_list, 
                                    array(
                                        'empty' => 'Select Result', 
                                        'class' => 'form-control custom-select vft-element select-result',
                                        'data-required' => 'true',
                                    ));
                                ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label"><strong>Remarks</strong> <span class="text-danger">*</span></label>
                                <textarea name="remark" class="form-control vft-element remark-result" placeholder="Remarks" rows="3" data-required="true"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <a id="submit-result" class="btn btn-info d-none d-lg-block m-l-15 text-white">Submit</a>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/highcomm/applicationapplicantview.js", CClientScript::POS_END);