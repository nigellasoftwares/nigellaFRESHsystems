    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="form-deliver-applicant">
                    ...
                    <table id="table-application-applicant" class="table table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php
                                        if(in_array($a->result_id,range(9,12))){
                                    ?>
                                        <input type="checkbox" name="applicant[]" class="applicant-osc chkbox" value="<?php echo $a->id; ?>">
                                    <?php
                                        } else if($a->result_id == 8){
                                            echo '<span class="label label-danger">NOT VERIFIED</span>';
                                        } else if(in_array($a->result_id,range(13,18))){
                                            echo '<span class="label label-success">RETURNED TO OSC</span>';
                                        }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <a href="index.php?r=Highcomm/ApplicationApplicantView&id=<?php echo $a->id; ?>" class="btn btn-sm waves-effect waves-light btn-success text-white" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="fa fa-search"></i></a>
                                </td>
                            </tr>
                        <?php
                            }
                ...
                <div class="m-t-30">
                    <a class="btn btn-success" id="return-osc">
                        <i class="fa fa-building-o"></i> Return To OSC
                    </a>
                </div>
            </form>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/highcomm/applicationbatch.js", CClientScript::POS_END);