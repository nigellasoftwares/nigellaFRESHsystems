                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-danger">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger"><?php echo number_format($stat['today']['track']['d']['hc']['not']); ?></h3>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo number_format($stat['today']['approve']); ?></h3>
                                <h5 class="text-muted m-b-0">Approved Today</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-info"><?php echo number_format($stat['today']['application']); ?></h3>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo number_format($stat['today']['track']['d']['hc']['verify']); ?></h3>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-danger">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger"><?php echo number_format($stat['today']['reject']); ?></h3>
                                <h5 class="text-muted m-b-0">Rejected Today</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="box bg-success text-center">
                            <h1 class="font-light text-white"><?php echo number_format($stat['all']['approve']); ?></h1>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="box bg-danger text-center">
                            <h1 class="font-light text-white"><?php echo number_format($stat['all']['reject']); ?></h1>
                            <h6 class="text-white">Total Rejected</h6>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-success badge-pill">HC</span></td>
                                    <td><?php echo number_format($stat['today']['approve']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">4</td>
                                    <td class="txt-oflo">Rejected</td>
                                    <td><span class="badge badge-success badge-pill">HC</span></td>
                                    <td><?php echo number_format($stat['today']['reject']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">5</td>
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="txt-oflo">Approved</td>
                                    <td><span class="badge badge-success badge-pill">HC</span></td>
                                    <td><?php echo number_format($stat['all']['approve']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">4</td>
                                    <td class="txt-oflo">Rejected</td>
                                    <td><span class="badge badge-success badge-pill">HC</span></td>
                                    <td><?php echo number_format($stat['all']['reject']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">5</td>
                                    <td class="txt-oflo">VTR</td>
