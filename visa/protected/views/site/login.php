...
<div class="card-body">
    <div class="row m-b-20">
        <div class="col-md-12 text-center">
            <img src="vendor/visafasttrack/images/visafasttrack_logo.png" />
        </div>
    </div>
    <form class="form-horizontal form-material" name="login_form" action="" method="post">
        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
                Copyright <?php echo date('Y'); ?>. All Rights Reserved.<br />FRESH Visa Login.
            </div>
        </div>
    </form>
</div>
...
<?php 
    $this->endWidget();
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/site/login.js", CClientScript::POS_END);