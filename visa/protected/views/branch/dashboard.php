                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0"><?php echo number_format($stat['today']['fee']); ?></h3>
                                <h5 class="text-muted m-b-0">Fee Today (BDT)</h5></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-info"><?php echo number_format($stat['today']['track']['r']['brn']['in']); ?></h3>
                                <h5 class="text-muted m-b-0">Return Today</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-danger">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger"><?php echo number_format($stat['today']['track']['r']['brn']['not']); ?></h3>
                    ...
                    <div class="card">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0"><i class="icon-login"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success"><?php echo number_format($stat['today']['track']['r']['brn']['verify']); ?></h3>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/visafasttrack/js/branch/dashboard.js", CClientScript::POS_END);