...
<head>
    ...
    <meta name="description" content="Visa Fast Track Login">
    ...
    <title>FRESH Visa Login</title>
    
    <!-- page css -->
    <link href="vendor/elite/dist/admin/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="skin-blue card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(vendor/visafasttrack/images/visafasttrack_login.jpg);">
