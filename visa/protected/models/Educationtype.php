...
/**
 * This is the model class for table "educationtypes".
 *
 * The followings are the available columns in table 'educationtypes':
 * @property integer $id
...
class Educationtype extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'educations' => array(self::HAS_MANY, 'Education', 'educationtype_id'),
