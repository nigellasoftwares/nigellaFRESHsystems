$(document).on('click','#scan-applicant',function() {
    $.ajax({
        url: "index.php?r=Highcomm/AjaxQRCheck",
        type: "POST",
        ...
        success: function(data){
            ...
            if(data.status == 'success'){
                ...
                } else if(data.result_id == 9 || data.result_id == 10 || data.result_id == 11 || data.result_id == 12 ) {
...
$(document).on('click','#verify-return',function() {
    $.ajax({
        url: "index.php?r=Highcomm/AjaxApplicantVerifyReturn",
        type: "POST",
