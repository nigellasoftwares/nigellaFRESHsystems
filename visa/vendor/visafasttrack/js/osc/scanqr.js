$(document).on('click','#scan-applicant',function() {
    $.ajax({
        url: "index.php?r=Osc/AjaxQRCheck",
        type: "POST",
        ...
        success: function(data){
            ...
            if(data.status == 'success'){
                ...
                } else if(data.result_id == 13){
                    $('.verify-check').attr('id','verify-return');
                } else if(data.result_id == 6 || data.result_id == 14) {
...
$(document).on('click','#verify-deliver',function() {
    $.ajax({
        url: "index.php?r=Osc/AjaxApplicantVerifyDeliver",
        type: "POST",
...
$(document).on('click','#verify-return',function() {
    $.ajax({
        url: "index.php?r=Osc/AjaxApplicantVerifyReturn",
        type: "POST",
        data: $('#form-verify-applicant').serialize(),
        dataType: "JSON",
        success: function(data){
