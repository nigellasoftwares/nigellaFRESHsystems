...
class District extends CActiveRecord {
    ...
    public function rules() {
        return array(
            array('state_id, created_by, updated_by', 'numerical', 'integerOnly' => true),
            array('name, sort, disable', 'length', 'max' => 255),
            array('created_at, updated_at', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, state_id, sort, created_at, created_by, updated_at, updated_by, disable', 'safe', 'on' => 'search'),
    ...
    public function relations() {
        return array(
            ...
            'companies' => array(self::HAS_MANY, 'Company', 'district_id'),
        );
    }
