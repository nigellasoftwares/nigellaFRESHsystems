...
class Nationality extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('name, country, sort, disable', 'length', 'max' => 255),
            array('created_at, updated_at', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, country, sort, created_at, created_by, updated_at, updated_by, disable', 'safe', 'on' => 'search'),
    ...
    public function relations() {
        return array(
            'workers' => array(self::HAS_MANY, 'Worker', 'nationality_id'),
