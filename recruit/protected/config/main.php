...
return array(
	...
	'db'=>array(
            'connectionString' => 'mysql:host=localhost;dbname=fresh_recruit',
            'emulatePrepare' => true,
            'username' => 'root',
    ...
    'dbmedical'=>array(
            'class'=>'CDbConnection',
            'connectionString' => 'mysql:host=localhost;dbname=fresh_medical',
            'emulatePrepare' => true,
            'username' => 'root',
            //'password' => 'pr0d@S1mp4t1@R00t5l4v3@MySql',
            'password' => 'password',
    ...
    'params'=>array(
        ...
        //'qrslip' => 'https://e-bfbms.com/demo/recruit',
        'qrlink' => 'http://localhost:81/fresh/qr',
        'qrslip' => 'http://localhost:81/fresh/recruit',
    ),
);