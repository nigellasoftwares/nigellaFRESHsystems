                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="index.php?r=Master/PrintFlight&id=<?php echo $k; ?>" target="_blank" class="btn btn-sm waves-effect waves-light btn-warning text-dark" data-toggle="tooltip" data-placement="top" title="Print Flight Slip" data-original-title="Print Flight Slip"><i class="fa fa-print"></i> <i class="fa fa-plane"></i></a>
                            </td>
                        </tr>
                    <?php
                        }    
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/imandor/js/master/flightlist.js", CClientScript::POS_END);