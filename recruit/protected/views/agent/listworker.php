<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Worker</h4>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Application for Foreign Worker <i class="fa fa-building-o"></i> <?php echo $agent->profile->company->name; ?></h4>
                ...
                <table id="table-application-transaction" class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo $link2; ?>&pid=1&id=<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-success text-white" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="fa fa-search"></i></a>
                            </td>
                        </tr>
                    <?php
                        }    
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/imandor/js/agent/listworker.js", CClientScript::POS_END);