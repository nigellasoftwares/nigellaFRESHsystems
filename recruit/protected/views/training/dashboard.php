                    ...
                    <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        <div class="d-flex flex-row">
                            ...
                            <div class="align-self-center m-l-20">
                                ...
                                <h5 class="text-muted m-b-0">Total Worker</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-success">
                                <h3 class="text-white box m-b-0"><i class="icon-people"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-success">2</h3>
                                <h5 class="text-muted m-b-0">Total Course</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        <div class="d-flex flex-row">
                            <div class="p-10 bg-danger">
                                <h3 class="text-white box m-b-0"><i class="icon-people"></i></h3></div>
                            <div class="align-self-center m-l-20">
                                <h3 class="m-b-0 text-danger">1</h3>
                ...
                <table id="table-application-transaction" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">Start Training Date</th>
                            <th width="10%">End Training Date</th>
                    ...
                    <tbody>
						<tr>
                            ...
                            <td>27 March 2023</td>
                            <td>
                                <a href="index.php?r=Training/Calendar" class="btn btn-sm waves-effect waves-light btn-success text-white" data-toggle="tooltip" data-placement="top" title="Attendance" data-original-title="Attendance"><i class="fa fa-file-pdf-o"></i></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>27 March 2023</td>
                            <td>
                                <a href="index.php?r=Training/Calendar2" class="btn btn-sm waves-effect waves-light btn-success text-white" data-toggle="tooltip" data-placement="top" title="Attendance" data-original-title="Attendance"><i class="fa fa-file-pdf-o"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/imandor/js/training/dashboard.js", CClientScript::POS_END);