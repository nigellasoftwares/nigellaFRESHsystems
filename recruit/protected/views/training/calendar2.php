            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                Certificate is not provided <a href="#" class="btn btn-sm waves-effect waves-light btn-dark text-white disabled" data-toggle="tooltip" data-placement="top" title="Certificate" data-original-title="Certificate"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                        </div>    
                    </div>
                </div>
