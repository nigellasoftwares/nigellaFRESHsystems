    ...
    <div class="card">
        <div class="card-body">
            <div class="pull-right">
                <a href="index.php?r=Admin/Photo&id=<?php echo $transaction->id; ?>" class="btn btn-info d-none d-lg-block m-l-15 text-white">
        ...
        <?php } ?>    
            ...
            <h4 class="card-title">Foreign Worker Passport Information</h4>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-9 p-20">
                    <div class="img-container"><img id="image" src="uploads/passports/<?php echo $transaction->guid; ?>.jpg" class="img-responsive" alt="Photo"></div>
                </div>
