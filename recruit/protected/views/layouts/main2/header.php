                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                                <img src="vendor/imandor/images/imandor_logo2.png" alt="i-MANDOR" class="dark-logo" />
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                                <div>
                                    <img src="vendor/imandor/images/user.png" alt="user-img" class="img-circle" height="40"> 
                                    <span class="text-white"><?php echo $user->profile->fullname; ?><!--<i class="ti-arrow-circle-down"></i>--></span>
                                </div>
                                <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                            </a>
                            <!--
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link waves-effect waves-light" href="#">
                                <img src="vendor/imandor/images/role.png" alt="user-img" class="img-circle" height="40"> 
                        ...
                        <li class="nav-item"> 
                            <a class="nav-link waves-effect waves-light" href="index.php?r=Site/Logout">
                                <img src="vendor/imandor/images/logout.png" alt="user-img" class="img-circle" height="40"> 
