    ...
    <div class="card">
        <div class="card-body">
            <div class="pull-right">
                <a href="index.php?r=Admin/RegisterAgent" class="btn btn-info d-none d-lg-block m-l-15 text-white">
                    <i class="fa fa-plus-circle"></i> Register New Agent
                </a>
            </div>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="index.php?r=Admin/ViewAgent&id=<?php echo $a['id']; ?>">View</a>
                                        <a class="dropdown-item" href="index.php?r=Admin/EditAgent&id=<?php echo $a['id'] ?>">Edit</a>
										<a class="dropdown-item" href="index.php?r=Admin/ResetAgent&id=<?php echo $a['id'] ?>">Reset Password</a>
                                        <a class="dropdown-item" href="index.php?r=Admin/LinkWorker&id=<?php echo $a['id']; ?>">Foreign Worker</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
