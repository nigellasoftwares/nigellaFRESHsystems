<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Medical Reminder</h4>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#month_01" role="tab">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#week_01" role="tab">
                            <span class="badge badge-warning"><?php echo number_format($reminder['week_01']); ?></span><br />1 Week
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <!-- 1 Month -->
                    <div class="tab-pane active" id="month_01" role="tabpanel">
                        <div class="card-body">
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-month01">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">1 Month Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-info ribbon-right">1 Month Reminder</div>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-week02">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">2 Weeks Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-warning ribbon-right text-dark">2 Weeks Reminder</div>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-week01">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">1 Week Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-warning ribbon-right text-dark">1 Week Reminder</div>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-day03">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">3 Days Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-danger ribbon-right">3 Days Reminder</div>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-day02">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">2 Days Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-danger ribbon-right">2 Days Reminder</div>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    <form id="form-view-day01">
                                        <div class="form-actions">
                                            <h3 class="m-b-20">1 Day Reminder for Medical Examination</h3>
                                            <div class="ribbon ribbon-danger ribbon-right">1 Day Reminder</div>
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/imandor/js/reminder/medical.js", CClientScript::POS_END);