<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Marital Status</h4>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="pull-right">
                <a class="btn btn-info d-none d-lg-block m-l-15 text-white item-add">
                    <i class="fa fa-plus-circle"></i> Add New Marital Status
                </a>
            </div>
            
            <h4 class="card-title"><span class="label label-primary"><?php echo $user->profile->company->name; ?></span></h4>
            <h4 class="card-title">Marital Status Lookup</h4>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a data-id="<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-info text-white item-edit" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                <a data-id="<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-danger text-white item-delete" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php
                        }    
