        ...
        <?php } ?>    
            ...
            <div class="table-responsive m-t-40">
                <table id="table-application-transaction" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                        $disabled = $user->role->name == 'MASTER' ? 'disabled' : NULL;
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?r=<?php echo Helpers::describeLink($user->role->id); ?>/View&id=<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-success text-white" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="fa fa-search"></i></a>
                                <a href="index.php?r=<?php echo Helpers::describeLink($user->role->id); ?>/Edit&id=<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-info text-white <?php echo $disabled; ?>" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                <a href="index.php?r=<?php echo Helpers::describeLink($user->role->id); ?>/PrintSlip&id=<?php echo $t->id; ?>" target="_blank" class="btn btn-sm waves-effect waves-light btn-warning text-dark" data-toggle="tooltip" data-placement="top" title="Slip" data-original-title="Slip"><i class="fa fa-file-text-o"></i></a>
                                <a data-id="<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-danger text-white transaction-delete <?php echo $disabled; ?>" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php
                        }    
