                                    ...
                                    <table id="table-application-total" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center vert-middle">
                                                    <a href="index.php?r=Sourceagent/View&id=<?php echo $t->id; ?>" class="btn btn-sm waves-effect waves-light btn-info text-white" data-toggle="tooltip" data-placement="top" title="View" data-original-title="View"><i class="fa fa-search"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            }    
...
<?php
    ...
    Yii::app()->clientScript->registerScriptFile("vendor/imandor/js/sourceagent/worker.js", CClientScript::POS_END);