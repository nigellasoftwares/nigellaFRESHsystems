...
<section>
    <table class="header-recruit">
        ...
        <tr>
            <td width="35%">
                <span class="text-bold">Worker Medical Slip</span><br />FRESH Recruitment System
            </td>
    ...
    <table class="meform-recruit">
        <tr>
            <td colspan="6" class="header-title">CLINIC DETAILS</td>
        </tr>
        <tr>
            <td width="50%" class="word">
                <span class="title">Clinic</span><br /><?php echo $c->company; ?>
            </td>
            <td width="50%" class="word">
                &nbsp;
            </td>
        ...
        <tr>
            <td width="50%" class="word">
                <span class="title">Code</span><br /><?php echo $c->code; ?>
            </td>
            <td width="50%" class="word">
                <span class="title">Doctor</span><br /><?php echo $c->name; ?>
            </td>
        </tr>
    </table>
